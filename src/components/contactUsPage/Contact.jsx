    ...
    <section class="text-gray-600 body-font relative">
                ...
                >
                    ...
                    <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        <div class="lg:w-1/2 px-6">
                            ...
                            <p class="mt-1">
                              <span className='text-[#2f539a]'>Dehradun Office : </span>Plot No 25 IT Park, Sahastradhara Road Dehradun 248001 <br />
                              <span className='text-[#2f539a]'>Haldwani Office : </span>Dahariya Road, Devalchaur, Landmark – Near The Base Kids School, Haldwani, Uttarakhand - 263139
                            </p>
                        </div>
                        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            ...
                            <p class="leading-relaxed">
                              <span className='text-[#2f539a]'>Dehradun Office : </span>7060615032 <br />
                              <span className='text-[#2f539a]'>Haldwani Office : </span>7060515032
                            </p>
                        </div>
                    </div>
            </motion.div>
          ...
          transition={{
            ...
            >
                ...
                <button class="font-bold hover:from-[#00b4d8] hover:to-[#0077b6] ... bg-gradient-to-r from-[#0077b6] to-[#00b4d8] ... text-[1.1rem] text-white transition-all duration-300 border-0 py-2 px-6  rounded text-lg">SEND</button>
